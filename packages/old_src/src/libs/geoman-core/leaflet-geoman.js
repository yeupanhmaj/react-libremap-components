(() => {
	...
	var rh = (t, e, i, r) => {
		if ((e && typeof e == 'object') || typeof e == 'function')
			for (const n of th(e))
				!ih.call(t, n) &&
					n !== i &&
					hr(t, n, { get: () => e[n], enumerable: !(r = Ql(e, n)) || r.enumerable });
		return t;
	};
	var xt = (t, e, i) => (
		(i = t != null ? Wl(eh(t)) : {}),
		rh(e || !t || !t.__esModule ? hr(i, 'default', { value: t, enumerable: !0 }) : i, t)
	);
	var pr = S((C_, cr) => {
		function sh() {
	...
	var kn = S((ay, vn) => {
		...
		function Yu() {
			(this.size = 0),
				(this.__data__ = { hash: new bn(), map: new (Xu || Hu)(), string: new bn() });
		}
		vn.exports = Yu;
	});
	var xn = S((oy, Mn) => {
	...
	var gi = S((Ry, vs) => {
		var Ls = ys(),
			...
			sp = Ls(
				...
				? Ls
				: (t) => ip(t) && rp.call(t, 'callee') && !np.call(t, 'callee');
		vs.exports = sp;
	});
	var Zt = S((Dy, ks) => {
	...
	var vi = S((Hy, Zs) => {
		...
		function xf(t, e) {
			...
			return (
				(e = e ?? kf),
				!!e && (i == 'number' || (i != 'symbol' && Mf.test(t))) && t > -1 && t % 1 == 0 && t < e
			);
		}
		Zs.exports = xf;
	});
	...
	var Ca = S((nL, wa) => {
		var yd = Ma(),
			...
			bd = xa
				? (t, e) =>
						xa(t, 'toString', { configurable: !0, enumerable: !1, value: yd(e), writable: !0 })
				: Ld;
		wa.exports = bd;
	});
	var Pa = S((sL, Ea) => {
	...
	var Oa = S((lL, Da) => {
		...
		function Id(t, e, i) {
			if (!Ad(i)) return !1;
			var r = typeof e;
			return (r == 'number' ? Dd(i) && Od(e, i.length) : r == 'string' && e in i)
				? Rd(i[e], t)
				: !1;
		}
		Da.exports = Id;
	...
	var Lo = S((Lb, yo) => {
		...
		function Tg(t, e) {
			if (Eg(t)) return !1;
			var i = typeof t;
			return i == 'number' || i == 'symbol' || i == 'boolean' || t == null || Pg(t)
				? !0
	...
	var xo = S((vb, Mo) => {
		var Dg = ko(),
			Og = 500;
		function Ag(t) {
			var e = Dg(t, (r) => (i.size === Og && i.clear(), r)),
				i = e.cache;
			return e;
		}
		Mo.exports = Ag;
	...
	var Qo = S((Ri, Di) => {
		((t, e) => {
					...
					for (; c > h; ) {
						if (c - h > 600) {
							var y = c - h + 1,
								...
								m = 0.5 * Math.sqrt((k * C * (y - C)) / y) * (g - y / 2 < 0 ? -1 : 1),
			...
			return (
				...
				(r.prototype.toBBox = (_) => _),
				(r.prototype.compareMinX = (_, x) => _.minX - x.minX),
				(r.prototype.compareMinY = (_, x) => _.minY - x.minY),
				...
				(r.prototype._build = function (_, x, b, R) {
					...
					R || ((R = Math.ceil(Math.log(O) / Math.log(A))), (A = Math.ceil(O / A ** (R - 1)))),
						((D = T([])).leaf = !1),
						(D.height = R);
					var q = Math.ceil(O / A),
				...
				(r.prototype._chooseSubtree = (_, x, b, R) => {
				...
				(r.prototype._allDistMargin = function (_, x, b, R) {
					_.children.sort(R);
					for (
						var D = this.toBBox, O = a(_, 0, x, D), A = a(_, b - x, b, D), q = d(O) + d(A), h = x;
						h < b - x;
						h++
					) {
						var c = _.children[h];
				...
				(r.prototype._adjustParentBBoxes = (_, x, b) => {
	...
	var zi = S((Q) => {
		...
		function Vm(t, e) {
			...
			switch (o.type) {
				...
				case 'Polygon':
					return (
						n < 0 && (n = l.length + n), s < 0 && (s = l[n].length + s), nt.point(l[n][s], a, e)
					);
				case 'MultiLineString':
					return (
						r < 0 && (r = l.length + r), s < 0 && (s = l[r].length + s), nt.point(l[r][s], a, e)
					);
				case 'MultiPolygon':
					return (
						r < 0 && (r = l.length + r),
	...
	typeof Object.assign != 'function' &&
		(Object.assign = function (t) {
			...
			for (var e = 1; e < arguments.length; e++) {
				var i = arguments[e];
				if (i != null) for (var r in i) Object.hasOwn(i, r) && (t[r] = i[r]);
			}
			return t;
		});
	((t) => {
		t.forEach((e) => {
			Object.hasOwn(e, 'remove') ||
	...
	var _g = {
			...
			_isRelevantForEdit(t) {
				return (
					...
					((!L.PM.optIn && !t.options.pmIgnore) || (L.PM.optIn && t.options.pmIgnore === !1)) &&
					!t._pmTempLayer &&
	...
	var yg = {
			...
			enableGlobalDragMode() {
				const t = L.PM.Utils.findLayers(this.map);
	...
	var Lg = {
				...
				(this._globalRemovalModeEnabled = !0),
					this.map.eachLayer((t) => {
						this._isRelevantForRemoval(t) &&
							(t.pm.enabled() && t.pm.disable(), t.on('click', this.removeLayer, this));
					}),
			...
			handleLayerAdditionInGlobalRemovalMode() {
				const t = this._addedLayersRemoval;
				if (((this._addedLayersRemoval = {}), this.globalRemovalModeEnabled()))
					for (const e in t) {
						const i = t[e];
						this._isRelevantForRemoval(i) &&
							(i.pm.enabled() && i.pm.disable(), i.on('click', this.removeLayer, this));
					}
			},
	...
	var bg = {
			...
			handleLayerAdditionInGlobalRotateMode() {
				const t = this._addedLayersRotate;
	...
	var go = xt(Ne()),
		vg = {
			...
			_fireCenterPlaced(t = 'Draw', e = {}) {
				const i = t === 'Draw' ? this._layer : void 0,
					r = t !== 'Draw' ? this._layer : void 0;
				this.__fire(
					this._layer,
					'pm:centerplaced',
					{ shape: this._shape, workingLayer: i, layer: r, latlng: this._layer.getLatLng() },
					t,
					e
				);
			},
	...
	var kg = () => ({
			...
			_onKeyListener(t) {
				...
				const i = { event: t, eventType: t.type, focusOn: e };
			...
			_onBlur(t) {
				t.altKey = !1;
				const e = { event: t, eventType: t.type, focusOn: 'document' };
	...
	function ve(t) {
		return t.reduce((e, i) => {
			if (i.length !== 0) {
				const r = Array.isArray(i) ? ve(i) : i;
	...
	function am(t, e, i) {
		...
		for (; Math.abs(q - h) > 1e-12; ) {
			...
			const B =
				A *
				p *
				(c + (A / 4) * (y * (-1 + 2 * c * c) - (A / 6) * c * (-3 + 4 * p * p) * (-3 + 4 * c * c)));
			(h = q), (q = u / (s * O) + B);
		}
		const g = _ * p - G * y * E,
	...
	function Ei(t, e, i, r, n = !0) {
		...
		for (let u = 0; u < i; u += 1) {
			if (n) (s = (u * 360) / i + r), (a = am(t, s, e)), (o = L.latLng(a.lng, a.lat));
				...
				const f = t.lat + Math.cos((2 * u * Math.PI) / i) * e,
	...
	function Ko(t, e, i = 'asc') {
		...
		return (l, u) => {
			...
			if (t === 'instanceofShape') {
				...
				if (!Object.hasOwn(l, t) || !Object.hasOwn(u, t)) return 0;
	...
	function Pi(t, e) {
		if (e.options.crs?.projection?.MAX_LATITUDE) {
			const i = e.options.crs?.projection?.MAX_LATITUDE;
	...
	var lm = L.Class.extend({
			...
			setGlobalOptions(t) {
				const e = (0, Si.default)(this.globalOptions, t);
				...
				this.map.pm.Draw.Circle.enabled() &&
					!!this.map.pm.Draw.Circle.options.resizeableCircle != !!e.resizeableCircle &&
			...
			getGeomanLayers(t = !1) {
				const e = L.PM.Utils.findLayers(this.map);
				if (!t) return e;
				const i = L.featureGroup();
				return (
					(i._pmTempLayer = !0),
					e.forEach((r) => {
						i.addLayer(r);
			...
			getGeomanDrawLayers(t = !1) {
				const e = L.PM.Utils.findLayers(this.map).filter((r) => r._drawnByGeoman === !0);
				if (!t) return e;
				const i = L.featureGroup();
				return (
					(i._pmTempLayer = !0),
	...
	var hm = L.Control.extend({
			...
			_renderButton() {
				const t = this.buttonsDomNode;
				(this.buttonsDomNode = this._makeButton(this._button)),
					t ? t.replaceWith(this.buttonsDomNode) : this._container.appendChild(this.buttonsDomNode);
			},
			onRemove() {
			...
			_makeButton(t) {
				const e = this.options.position.indexOf('right') > -1 ? 'pos-right' : '',
					i = L.DomUtil.create('div', `button-container  ${e}`, this._container);
				t.title && i.setAttribute('title', t.title);
				const r = L.DomUtil.create('a', 'leaflet-buttons-control-button', i);
				r.setAttribute('role', 'button'), r.setAttribute('tabindex', '0'), (r.href = '#');
				const n = L.DomUtil.create('div', `leaflet-pm-actions-container ${e}`, i),
					s = t.actions,
					a = {
						cancel: {
				...
				(t._preparedActions = s.map((l) => {
					...
					const d = L.DomUtil.create('a', `leaflet-pm-action ${e} action-${u}`, n);
					if (
						...
						L.DomEvent.addListener(d, 'click', P, this),
							...
							L.DomEvent.addListener(d, 'click', () => this._updateActiveAction(t));
					}
					return f;
				})),
					this._updateActiveAction(t),
					t.toggleStatus && L.DomUtil.addClass(i, 'active');
				const o = L.DomUtil.create('div', 'control-icon', r);
				return (
	...
	var um = L.Class.extend({
			...
			initialize(t) {
				(this.customButtons = []),
					(this.options.positions = { draw: '', edit: '', options: '', custom: '' }),
					this.init(t);
			},
			reinit() {
			...
			_showHideButtons() {
				...
				this.options.drawControls === !1 &&
					...
					this.options.editControls === !1 &&
						(e = e.concat(Object.keys(t).filter((i) => t[i]._button.tool === 'edit'))),
					this.options.optionsControls === !1 &&
						(e = e.concat(Object.keys(t).filter((i) => t[i]._button.tool === 'options'))),
					this.options.customControls === !1 &&
						(e = e.concat(Object.keys(t).filter((i) => t[i]._button.tool === 'custom')));
				for (const i in t)
			...
			copyDrawControl(t, e) {
				...
				const i = this._btnNameMapping(t);
				...
				const r = this.map.pm.Draw.createNewDrawInstance(e.name, i);
				e = { ...this.buttons[i]._button, ...e };
				const s = this.createCustomControl(e);
			...
			createCustomControl(t) {
				...
				const i = this._addButton(t.name, new L.Control.PMButton(e));
			...
			getButtonsInBlock(t) {
				const e = {};
				if (t)
					for (const i in this.getButtons()) {
						const r = this.getButtons()[i];
						(r._button.tool === t || (t === 'draw' && !r._button.tool)) && (e[i] = r);
					}
				return e;
			},
			changeControlOrder(t = []) {
				const e = this._shapeMapping(),
					i = [];
				t.forEach((u) => {
	...
	var cm = {
			...
			_cleanupSnapping(t) {
				...
				delete this._snapList,
					this.throttledList &&
						(this._map.off('layeradd', this.throttledList, this), (this.throttledList = void 0)),
			...
			_handleSnapping(t) {
				...
				if (
					...
					return !1;
				const i = this._calcClosestLayer(e.getLatLng(), this._snapList);
				...
				const s = this.options.snapDistance,
					a = {
						marker: e,
						shape: this._shape,
						snapLatLng: n,
				...
				i.off('layerremove', this._handleSnapLayerRemoval, this),
					...
					i.eachLayer((r) => {
						if (
							...
							r.pm._hiddenPolyCircle
								...
								: r instanceof L.ImageOverlay && (r = L.rectangle(r.getBounds())),
								t.push(r);
							const n = L.polyline([], { color: 'red', pmIgnore: !0 });
							(n._pmTempLayer = !0),
								e.push(n),
								(r instanceof L.Circle || r instanceof L.CircleMarker) && e.push(n);
						}
					}),
					...
					this._otherSnapLayers
						? (this._otherSnapLayers.forEach(() => {
								const r = L.polyline([], { color: 'red', pmIgnore: !0 });
			...
			_handleSnapLayerRemoval({ layer: t }) {
				...
				const e = this._snapList.findIndex((i) => i._leaflet_id === t._leaflet_id);
			...
			_calcClosestLayers(t, e, i = 1) {
				...
				e.forEach((a, o) => {
					...
					i === 1 && (n.distance === void 0 || l.distance - 5 <= n.distance)
						? (l.distance + 5 < n.distance && (r = []), (n = l), (n.layer = a), r.push(n))
						: i !== 1 && ((n = {}), (n = l), (n.layer = a), r.push(n));
				}),
					i !== 1 && (r = r.sort((a, o) => a.distance - o.distance)),
					i === -1 && (i = r.length);
				const s = this._getClosestLayerByPriority(r, i);
					...
					o = (l) => {
						l.forEach((u, f) => {
							...
							if (this.options.snapSegment) {
								...
								const E = l[P];
								if (E) {
									const T = this._getDistanceToSegment(i, t, d, E);
									(s === void 0 || T < s) && ((s = T), (a = [d, E]));
								}
							} else {
								const d = this._getDistance(i, t, u);
			...
			_checkPrioritiySnapping(t) {
				...
				if (this.options.snapVertex) {
					...
					if (this.options.snapMiddle) {
						const d = L.PM.Utils.calcMiddleLatLng(e, i, r),
							P = this._getDistance(e, d, n);
						P < a && P < o && ((l = d), (u = P));
					}
					const f = this.options.snapDistance;
					u < f && (s = l);
				}
				return { ...s };
			},
			...
			_getDistanceToSegment(t, e, i, r) {
				const n = t.latLngToContainerPoint(e),
	...
	var pm = L.Class.extend({
			...
			setPathOptions(t, e = !1) {
				e
					? (this.options.pathOptions = (0, Yo.default)(this.options.pathOptions, t))
			...
			createNewDrawInstance(t, e) {
				const i = this._getShapeFromBtnName(e);
			...
			_finishLayer(t) {
				t.pm &&
					(t.pm.setOptions(this.options), (t.pm._shape = this._shape), (t.pm._map = this._map)),
	...
	X.Marker = X.extend({
		...
		_createMarker(t) {
			...
			const e = this._hintMarker.getLatLng(),
	...
	X.Line = X.extend({
		...
		enable(t) {
			L.Util.setOptions(this, t),
				...
				(this._layer = L.polyline([], { ...this.options.templineStyle, pmIgnore: !1 })),
		...
		_syncHintLine() {
			const t = this._layer.getLatLngs();
			if (t.length > 0) {
		...
		_syncHintMarker(t) {
			...
			const e = this._layer._defaultShape().slice();
		...
		_handleSelfIntersection(t, e) {
			const i = L.polyline(this._layer.getLatLngs());
			t && (e || (e = this._hintMarker.getLatLng()), i.addLatLng(e));
			const r = zt(i.toGeoJSON(15));
			(this._doesSelfIntersect = r.features.length > 0),
				this._doesSelfIntersect
					...
					: this._hintline.isEmpty() ||
						((this.isRed = !1), this._hintline.setStyle(this.options.hintlineStyle));
		},
		_createVertex(t) {
			if (
				!this.options.allowSelfIntersection &&
			...
			this._setTooltipText(),
				...
				this.options.finishOn === 'snap' && this._hintMarker._snapped && this._finishShape(t);
		},
		_setHintLineAfterNewVertex(t) {
			this._hintline.setLatLngs([t, t]);
		},
		_removeLastVertex() {
			const t = this._markers;
			if (t.length <= 1) {
				this.disable();
				return;
			}
		...
		_finishShape() {
			...
			const e = L.polyline(t, this.options.pathOptions);
			this._setPane(e, 'layerPane'),
				this._finishLayer(e),
				e.addTo(this._map.pm._getContainingLayer()),
				this._fireCreate(e),
				this.options.snappable && this._cleanupSnapping();
			const i = this._hintMarker.getLatLng();
			this.disable(),
				this.options.continueDrawing && (this.enable(), this._hintMarker.setLatLng(i));
		},
		_createMarker(t) {
			const e = new L.Marker(t, { draggable: !1, icon: L.divIcon({ className: 'marker-icon' }) });
			return (
		...
		_setTooltipText() {
			let { length: t } = this._layer.getLatLngs().flat(),
				e = '';
			t <= 1 ? (e = V('tooltips.continueLine')) : (e = V('tooltips.finishLine')),
	...
	X.Polygon = X.Line.extend({
		...
		_setTooltipText() {
			let { length: t } = this._layer.getLatLngs().flat(),
				e = '';
			t <= 2 ? (e = V('tooltips.continueLine')) : (e = V('tooltips.finishPoly')),
				this._hintMarker.setTooltipContent(e);
		},
		_finishShape() {
			if (
			...
			const e = L.polygon(t, this.options.pathOptions);
			this._setPane(e, 'layerPane'),
				this._finishLayer(e),
				e.addTo(this._map.pm._getContainingLayer()),
				this._fireCreate(e),
	...
	X.Rectangle = X.extend({
		...
		enable(t) {
			if (
				...
				this._styleMarkers = [];
				for (let e = 0; e < 2; e += 1) {
					const i = L.marker(this._map.getCenter(), {
		...
		_setRectangleOrigin() {
			const t = this._startMarker.getLatLng();
			t &&
				(this._layerGroup.addLayer(this._layer),
		...
		_syncRectangleSize() {
			const t = Pi(this._startMarker.getLatLng(), this._map),
		...
		_findCorners() {
			const t = this._layer.getLatLngs()[0];
		...
		_finishShape(t) {
			...
			if (
				...
				return;
			const r = L.rectangle([i, e], this.options.pathOptions);
			if (this.options.rectangleAngle) {
				const s = L.PM.Utils._getRotatedRectangle(
					i,
					e,
					this.options.rectangleAngle || 0,
					this._map
			...
			this._setPane(r, 'layerPane'),
				...
				this._fireCreate(r);
			const n = this._hintMarker.getLatLng();
			this.disable(),
				this.options.continueDrawing && (this.enable(), this._hintMarker.setLatLng(n));
		},
		setStyle() {
	...
	X.CircleMarker = X.extend({
		...
		_placeCircleCenter() {
			const t = this._centerMarker.getLatLng();
			t &&
		...
		_syncCircleRadius() {
			...
			this.options[this._minRadiusOption] && i < this.options[this._minRadiusOption]
				? this._layer.setRadius(this.options[this._minRadiusOption])
				: this.options[this._maxRadiusOption] && i > this.options[this._maxRadiusOption]
		...
		_finishShape(t) {
			...
			if (this.options[this._editableOption]) {
				const a = this._hintMarker.getLatLng();
			...
			const r = { ...this.options.pathOptions, radius: i },
			...
			this._setPane(n, 'layerPane'),
				...
				this._fireCreate(n);
			const s = this._hintMarker.getLatLng();
			this.disable(),
				this.options.continueDrawing && (this.enable(), this._hintMarker.setLatLng(s));
		},
		_getNewDestinationOfHintMarker() {
			let t = this._hintMarker.getLatLng();
			if (this.options[this._editableOption]) {
				if (!this._layerGroup.hasLayer(this._centerMarker)) return t;
				const e = this._centerMarker.getLatLng(),
	...
	function Hm(t, e, i) {
		...
		var r = rt(t),
			...
			o = lt(r[1]),
			l = lt(n[1]),
			u = Math.sin(s / 2) ** 2 + Math.sin(a / 2) ** 2 * Math.cos(o) * Math.cos(l);
				...
				for (var a = ot(s), o = 0; o < a.length - 1; o++) {
					...
					G.features.length > 0 &&
						...
						u.properties.dist < r.properties.dist &&
							((r = u), (r.properties.index = o + 1), (r.properties.location = n + f)),
						_ && _.properties.dist < r.properties.dist && ((r = _), (r.properties.index = o)),
						(n += f);
				}
			}),
			r
	...
	function a_(t, e) {
		for (var i = !1, r = 0, n = e.coordinates; r < n.length; r++) {
			var s = n[r];
			if (
				(se({ type: 'Point', coordinates: s }, t, { ignoreEndVertices: !0 }) && (i = !0),
	...
	var Xe = (t) => () => t;
	var Ee = (t) => {
		const e = t ? (i, r) => r.minus(i).abs().isLessThanOrEqualTo(t) : Xe(!1);
		...
		const e = t
			? (i, r, n, s, a) =>
					i
						.exponentiatedBy(2)
						.isLessThanOrEqualTo(
							s.minus(r).exponentiatedBy(2).plus(a.minus(n).exponentiatedBy(2)).times(t)
						)
			: Xe(!1);
		return (i, r, n) => {
			const s = i.x,
	...
	function Cl(t) {
		...
		function b(h, c) {
			...
			if (c == null) {
				...
				(k = w.indexOf('.')) > -1 && (w = w.replace('.', '')),
					(C = w.search(/e/i)) > 0
						? (k < 0 && (k = C), (k += +w.slice(C + 1)), (w = w.substring(0, C)))
						: k < 0 && (k = w.length);
			} else {
			...
			(b.config = b.set =
				(h) => {
					...
					if (h != null)
						if (typeof h == 'object') {
							if (
								(Object.hasOwn(h, (c = 'DECIMAL_PLACES')) && ((p = h[c]), J(p, 0, tt, c), (a = p)),
								Object.hasOwn(h, (c = 'ROUNDING_MODE')) && ((p = h[c]), J(p, 0, 8, c), (o = p)),
								Object.hasOwn(h, (c = 'EXPONENTIAL_AT')) &&
									((p = h[c]),
									p && p.pop
										? (J(p[0], -tt, 0, c), J(p[1], 0, tt, c), (l = p[0]), (u = p[1]))
										: (J(p, -tt, tt, c), (l = -(u = p < 0 ? -p : p)))),
								Object.hasOwn(h, (c = 'RANGE')))
							)
								if (((p = h[c]), p && p.pop))
									J(p[0], -tt, -1, c), J(p[1], 1, tt, c), (f = p[0]), (d = p[1]);
								else if ((J(p, -tt, tt, c), p)) f = -(d = p < 0 ? -p : p);
								else throw Error(ht + c + ' cannot be zero: ' + p);
							if (Object.hasOwn(h, (c = 'CRYPTO')))
								if (((p = h[c]), p === !!p))
									if (p)
										if (
											typeof crypto < 'u' &&
							...
							if (
								(Object.hasOwn(h, (c = 'MODULO_MODE')) && ((p = h[c]), J(p, 0, 9, c), (E = p)),
								Object.hasOwn(h, (c = 'POW_PRECISION')) && ((p = h[c]), J(p, 0, tt, c), (T = p)),
								Object.hasOwn(h, (c = 'FORMAT')))
							)
								if (((p = h[c]), typeof p == 'object')) G = p;
								else throw Error(ht + c + ' not an object: ' + p);
							if (Object.hasOwn(h, (c = 'ALPHABET')))
						...
						if (crypto.getRandomValues) {
							...
							for (y = crypto.randomBytes((C *= 7)); v < C; )
								(m =
									...
									(y[v + 5] << 8) +
									y[v + 6]),
									m >= 9e15 ? crypto.randomBytes(7).copy(y, v) : (w.push(m % 1e14), (v += 7));
							v = C / 7;
						} else throw ((P = !1), Error(ht + 'crypto unavailable'));
					if (!P) for (; v < C; ) (m = c()), m < 9e15 && (w[v++] = m % 1e14);
					for (
						C = w[--v], p %= F, C && p && ((m = Qi[F - p]), (w[v] = dt(C / m) * m));
						w[v] === 0;
						w.pop(), v--
					);
					if (v < 0) w = [(k = 0)];
				...
				function c(p, y, g, k) {
					for (var C, m = [0], v, w = 0, M = p.length; w < M; ) {
						...
						for (m[0] += k.indexOf(p.charAt(w++)), C = 0; C < m.length; C++)
							m[C] > g - 1 &&
								(m[C + 1] == null && (m[C + 1] = 0), (m[C + 1] += (m[C] / g) | 0), (m[C] %= g));
					}
					return m.reverse();
				}
				return (p, y, g, k, C) => {
					...
					if (
						...
						(B =
							U < 4
								...
								: $ > M ||
									($ == M && (U == 4 || B || (U == 6 && N[v - 1] & 1) || U == (I.s < 0 ? 8 : 7)))),
						v < 1 || !N[0])
					)
				...
				return (y, g, k, C, m) => {
					...
					for (
						$ = new b(ct),
							...
							w = y.e - g.e,
							ct = k + w + 1,
							m || ((m = Lt), (w = gt(y.e / F) - gt(g.e / F)), (ct = (ct / F) | 0)),
							M = 0;
						Z[M] == (st[M] || 0);
						M++
					);
					if ((Z[M] > (st[M] || 0) && w--, ct < 0)) W.push(1), (B = !0);
						...
						for (
							si = st.length,
								...
								ct += 2,
								I = dt(m / (Z[0] + 1)),
								I > 1 && ((Z = h(Z, I, m)), (st = h(st, I, m)), (bt = Z.length), (si = st.length)),
								De = bt,
								U = st.slice(0, bt),
								j = U.length;
							j < bt;
				...
				if (y.test(M)) k.s = isNaN(M) ? null : M < 0 ? -1 : 1;
					...
					if (
						...
						((M = M.replace(
							h,
							(B, I, N) => (
								(w = (N = N.toLowerCase()) == 'x' ? 16 : N == 'b' ? 2 : 8), !v || v == w ? I : B
							)
						)),
		...
		function A(h, c, p, y) {
			...
			if (B) {
				t: {
					...
					if (
						((y = y || c < 0 || B[w + 1] != null || (C < 0 ? v : v % I[g - C - 1])),
						(y =
							p < 4
								? (M || y) && (p == 0 || p == (h.s < 0 ? 3 : 2))
								: M > 5 ||
									(M == 5 &&
										(p == 4 ||
											y ||
											(p == 6 && ((k > 0 ? (C > 0 ? v / I[g - C] : 0) : B[w - 1]) % 10) & 1) ||
											p == (h.s < 0 ? 8 : 7)))),
						c < 1 || !B[0])
					)
						return (
		...
		function q(h) {
			...
			return p === null
				? h.toString()
				: ((c = ft(h.c)), (c = p <= l || p >= u ? Je(c, p) : Et(c, p, '0')), h.s < 0 ? '-' + c : c);
		}
		return (
			...
			(n.decimalPlaces = n.dp =
				function (h, c) {
					var p, y, g;
					if (h != null)
						return J(h, 0, tt), c == null ? (c = o) : J(c, 0, 8), A(new b(this), h + this.e + 1, c);
					if (!(p = this.c)) return null;
			...
			(n.exponentiatedBy = n.pow =
				function (h, c) {
					...
					if (
						(c != null && (c = new b(c)),
						(m = h.e > 14),
						!B.c || !B.c[0] || (B.c[0] == 1 && !B.e && B.c.length == 1) || !h.c || !h.c[0])
					)
						return (M = new b((+q(B)) ** (m ? h.s * (2 - Ye(h)) : +q(h)))), c ? M.mod(c) : M;
					if (((v = h.s < 0), c)) {
			...
			(n.minus = function (h, c) {
				...
				if (m != c) return (h.s = -c), this.plus(h);
				var v = this.e / F,
					w = h.e / F,
					M = this.c,
					B = h.c;
				if (!v || !w) {
					if (!M || !B) return M ? ((h.s = -c), h) : new b(B ? this : NaN);
					if (!M[0] || !B[0]) return B[0] ? ((h.s = -c), h) : new b(M[0] ? this : o == 3 ? -0 : 0);
				}
				if (((v = gt(v)), (w = gt(w)), (M = M.slice()), (m = v - w))) {
					for (
						(k = m < 0) ? ((m = -m), (g = M)) : ((w = v), (g = B)), g.reverse(), c = m;
						c--;
						g.push(0)
					);
					g.reverse();
			...
			(n.modulo = n.mod =
				function (h, c) {
					...
					return (
						(h = new b(h, c)),
						!this.c || !h.s || (h.c && !h.c[0])
							? new b(NaN)
							: !h.c || (this.c && !this.c[0])
								? new b(this)
								: (E == 9
										? ((y = h.s), (h.s = 1), (p = e(this, h, 0, 3)), (h.s = y), (p.s *= y))
										: (p = e(this, h, 0, E)),
									(h = this.minus(p.times(h))),
									!h.c[0] && E == 1 && (h.s = this.s),
									h)
					);
				}),
			(n.multipliedBy = n.times =
				function (h, c) {
					...
					if (!j || !it || !j[0] || !it[0])
						return (
							!this.s || !h.s || (j && !j[0] && !it) || (it && !it[0] && !j)
								? (h.c = h.e = h.s = null)
								: ((h.s *= this.s), !j || !it ? (h.c = h.e = null) : ((h.c = [0]), (h.e = 0))),
							h
						);
					for (
						y = gt(this.e / F) + gt(h.e / F),
							h.s *= this.s,
							v = j.length,
							B = it.length,
			...
			(n.plus = function (h, c) {
				...
				if (g != c) return (h.s = -c), this.minus(h);
				var k = this.e / F,
					C = h.e / F,
					m = this.c,
					v = h.c;
				if (!k || !C) {
					...
					if (!m[0] || !v[0]) return v[0] ? h : new b(m[0] ? this : g * 0);
				}
				...
				for (
					g = m.length, c = v.length, g - c < 0 && ((p = v), (v = m), (m = p), (c = g)), g = 0;
					c;
				)
			...
			(n.precision = n.sd =
				function (h, c) {
					var p, y, g;
					if (h != null && h !== !!h)
						return J(h, 1, tt), c == null ? (c = o) : J(c, 0, 8), A(new b(this), h, c);
					if (!(p = this.c)) return null;
					if (((g = p.length - 1), (y = g * F + 1), (g = p[g]))) {
						for (; g % 10 == 0; g /= 10, y--);
						for (g = p[0]; g >= 10; g /= 10, y++);
					}
					return h && this.e + 1 > y && (y = this.e + 1), y;
				}),
			...
			(n.squareRoot = n.sqrt =
				function () {
					var h,
						...
						M = new b('0.5');
					if (m !== 1 || !C || !C[0])
						return new b(!m || (m < 0 && (!C || C[0])) ? NaN : C ? this : 1 / 0);
					if (
						((m = Math.sqrt(+q(this))),
						m == 0 || m == 1 / 0
							? ((c = ft(C)),
								...
								m == 1 / 0
									? (c = '5e' + v)
									: ((c = m.toExponential()), (c = c.slice(0, c.indexOf('e') + 1) + v)),
								(p = new b(c)))
							: (p = new b(m + '')),
						p.c[0])
					) {
						for (v = p.e, m = v + w, m < 3 && (m = 0); ; )
							if (
								((g = p),
								(p = M.times(g.plus(e(this, g, w, 1)))),
								ft(g.c).slice(0, m) === (c = ft(p.c)).slice(0, m))
							)
								if (
									(p.e < v && --m, (c = c.slice(m - 3, m + 1)), c == '9999' || (!y && c == '4999'))
								) {
									if (!y && (A(g, g.e + a + 2, 0), g.times(g).eq(this))) {
										p = g;
										break;
									}
									(w += 4), (m += 4), (y = 1);
									...
									(!+c || (!+c.slice(1) && c.charAt(0) == '5')) &&
										(A(p, p.e + a + 2, 1), (h = !p.times(p).eq(this)));
									break;
								}
					}
			...
			(n.toFraction = function (h) {
				...
				if (h != null && ((m = new b(h)), (!m.isInteger() && (m.c || m.s !== 1)) || m.lt(s)))
					throw Error(
						ht + 'Argument ' + (m.isInteger() ? 'out of range: ' : 'not an integer: ') + q(m)
					);
				if (!K) return new b(this);
				for (
					c = new b(s),
						w = p = new b(s),
						y = v = new b(s),
						I = ft(K),
						k = c.e = I.length - this.e - 1,
				...
				return (
					...
					(B =
						e(w, y, k, o)
							.minus(this)
							.abs()
							.comparedTo(e(v, p, k, o).minus(this).abs()) < 1
							? [w, y]
							: [v, p]),
					(d = C),
					B
					...
					g === null
						...
						: (h == null
								...
								: h === 10 && x
									...
									: (J(h, 2, _.length, 'Base'), (c = i(Et(ft(p.c), g, '0'), 10, h, y, !0))),
							y < 0 && p.c[0] && (c = '-' + c)),
					c
				);
			}),
			...
			for (;;)
				if (((u = l(o.key, e)), u > 0)) {
					...
					if (
						f == null ||
						((u = l(f.key, e)),
						u > 0 && ((o.left = f.right), (f.right = o), (o = f), (f = o.left), f == null))
					)
						break;
					...
					if (
						f == null ||
						((u = l(f.key, e)),
						u < 0 && ((o.right = f.left), (f.left = o), (o = f), (f = o.right), f == null))
					)
						break;
	...
	var Pt = class t extends er {
			...
			deleteAll(e) {
				for (const i of e) this.delete(i);
			}
			forEach(e) {
			...
			retainAll(e) {
				const i = new t(this.compare, this.validKey),
				...
				i.size != this.size &&
					((this.root = i.root), (this.size = i.size), this.modificationCount++);
			}
			lookup(e) {
			...
			intersection(e) {
				const i = new t(this.compare, this.validKey);
				for (const r of this) e.has(r) && i.add(r);
				return i;
			}
			difference(e) {
				const i = new t(this.compare, this.validKey);
				...
				function i(n, s) {
					...
					do {
						if (((a = n.left), (o = n.right), a != null)) {
							const l = new Kt(a.key);
							(s.left = l), i(a, l);
						}
						if (o != null) {
							const l = new Kt(o.key);
							(s.right = l), (n = o), (s = l);
						}
					} while (o != null);
				}
	...
	var ae = (t, e) =>
		...
		Pe = (t, e) => {
			if (
				...
				return null;
			const i = t.ll.x.isLessThan(e.ll.x) ? e.ll.x : t.ll.x,
	...
	var Ze = (t, e) => t.x.times(e.y).minus(t.y.times(e.x)),
		...
		We = (t) => Tl(t, t).sqrt(),
		Rl = (t, e, i) => {
			const r = { x: e.x.minus(t.x), y: e.y.minus(t.y) },
		...
		Sl = (t, e, i) =>
			e.y.isZero() ? null : { x: t.x.plus(e.x.div(e.y).times(i.minus(t.y))), y: i },
		Bl = (t, e, i) =>
			e.x.isZero() ? null : { x: i, y: t.y.plus(e.y.div(e.x).times(i.minus(t.x))) },
		Ol = (t, e, i, r) => {
			...
			const s = { x: i.x.minus(t.x), y: i.y.minus(t.y) },
				a = Ze(s, e).div(n),
				o = Ze(s, r).div(n),
	...
	var et = class t {
		...
		consumedBy;
		static compare(e, i) {
			const r = t.comparePoints(e.point, i.point);
			return r !== 0
				? r
				: (e.point !== i.point && e.link(i),
					e.isLeft !== i.isLeft ? (e.isLeft ? 1 : -1) : Mt.compare(e.segment, i.segment));
		}
		...
		Mt = class t {
			...
			static compare(e, i) {
				...
				if (r.isLessThan(n)) {
					...
					const d = e.comparePoint(i.leftSE.point);
					if (d < 0) return 1;
					if (d > 0) return -1;
					const P = i.comparePoint(e.rightSE.point);
					return P !== 0 ? P : -1;
				}
				if (r.isGreaterThan(n)) {
					if (o.isLessThan(l) && o.isLessThan(f)) return -1;
					if (o.isGreaterThan(l) && o.isGreaterThan(f)) return 1;
					const d = i.comparePoint(e.leftSE.point);
					if (d !== 0) return d;
					const P = e.comparePoint(i.rightSE.point);
			...
			getIntersection(e) {
				...
				if (P) return a;
				if (d) return l;
				const E = Ol(s, this.vector(), o, e.vector());
			...
			split(e) {
				...
				const o = new t(n, a, this.rings.slice(), this.windings.slice());
				return (
					et.comparePoints(o.leftSE.point, o.rightSE.point) > 0 && o.swapEvents(),
					et.comparePoints(this.leftSE.point, this.rightSE.point) > 0 && this.swapEvents(),
	...
	var Qe = class {
		...
		sr = class {
			...
			getSweepEvents() {
				...
				for (let i = 0, r = this.interiorRings.length; i < r; i++) {
					const n = this.interiorRings[i].getSweepEvents();
		...
		Se = class {
			...
			constructor(e, i) {
				...
				(this.polys = []),
					(this.bbox = {
						ll: { x: new mt(Number.POSITIVE_INFINITY), y: new mt(Number.POSITIVE_INFINITY) },
						ur: { x: new mt(Number.NEGATIVE_INFINITY), y: new mt(Number.NEGATIVE_INFINITY) },
					});
				for (let r = 0, n = e.length; r < n; r++) {
					const s = new sr(e[r], this);
					s.bbox.ll.x.isLessThan(this.bbox.ll.x) && (this.bbox.ll.x = s.bbox.ll.x),
						s.bbox.ll.y.isLessThan(this.bbox.ll.y) && (this.bbox.ll.y = s.bbox.ll.y),
						s.bbox.ur.x.isGreaterThan(this.bbox.ur.x) && (this.bbox.ur.x = s.bbox.ur.x),
						s.bbox.ur.y.isGreaterThan(this.bbox.ur.y) && (this.bbox.ur.y = s.bbox.ur.y),
			...
			getSweepEvents() {
				...
				for (let i = 0, r = this.polys.length; i < r; i++) {
					const n = this.polys[i].getSweepEvents();
					for (let s = 0, a = n.length; s < a; s++) e.push(n[s]);
				}
				return e;
			}
	...
	var ti = class t {
			...
			static factory(e) {
				...
				for (let r = 0, n = e.length; r < n; r++) {
					...
					for (; (a = o), (o = l), u.push(o), o.point !== f; )
						for (;;) {
							const P = o.getAvailableLinkedEvents();
							if (P.length === 0) {
								const G = u[0].point,
			...
			getGeom() {
				...
				const s = this.isExteriorRing() ? 1 : -1,
			...
			enclosingRing() {
				return (
					this._enclosingRing === void 0 && (this._enclosingRing = this._calcEnclosingRing()),
					this._enclosingRing
				);
			}
			_calcEnclosingRing() {
	...
	var Be = class {
		...
		process(e) {
			...
			if (e.isLeft) {
				...
				let o = null;
				if (s) {
					const l = s.getIntersection(i);
					if (l !== null && (i.isAnEndpoint(l) || (o = l), !s.isAnEndpoint(l))) {
						const u = this._splitSafely(s, l);
						for (let f = 0, d = u.length; f < d; f++) r.push(u[f]);
					}
				}
				if (a !== null || o !== null) {
					let l = null;
					a === null ? (l = o) : o === null ? (l = a) : (l = et.comparePoints(a, o) <= 0 ? a : o),
	...
	var ar = class {
			...
			run(e, i, r) {
				...
				const s = new Pt(et.compare);
				for (let f = 0, d = n.length; f < d; f++) {
					const P = n[f].getSweepEvents();
	...
	X.Cut = X.Polygon.extend({
		...
		cut(t) {
			...
			Object.keys(e)
				...
				.filter(
					(n) => (!L.PM.optIn && !n.options.pmIgnore) || (L.PM.optIn && n.options.pmIgnore === !1)
				)
				...
				.filter((n) => {
					try {
						const s = !!pt(t.toGeoJSON(15), n.toGeoJSON(15)).features.length > 0;
				...
				.forEach((n) => {
					...
					const l = o.addTo(this._map.pm._getContainingLayer());
					if (
						...
						l.getLayers && l.getLayers().length === 0 && this._map.pm.removeLayer({ target: l }),
						...
						const u = this.options.layersToCut.indexOf(n);
	...
	X.Text = X.extend({
		...
		_createMarker(t) {
			...
			if (((this.textArea = this._createTextArea()), this.options.textOptions?.className)) {
				const n = this.options.textOptions.className.split(' ');
				this.textArea.classList.add(...n);
			}
			const i = this._createTextIcon(this.textArea),
			...
			if (
				...
				(r.pm.textArea = this.textArea),
					L.setOptions(r.pm, { removeIfEmpty: this.options.textOptions?.removeIfEmpty ?? !0 });
				const n = this.options.textOptions?.focusAfterDraw ?? !0;
				r.pm._createTextMarker(n),
					this.options.textOptions?.text && r.pm.setText(this.options.textOptions.text);
			}
			this._fireCreate(r),
				this._cleanupSnapping(),
				this.disable(),
	...
	var y_ = {
			...
			_simulateMouseUpEvent(t) {
				const i = { originalEvent: t.touches ? t.touches[0] : t, target: this._layer };
				return (
				...
				const { latlng: e } = t,
					...
					r = (n) =>
						n.map((s) => {
							...
							const a = { lat: s.lat + i.lat, lng: s.lng + i.lng };
							return (s.alt || s.alt === 0) && (a.alt = s.alt), a;
						});
				if (
					(this._layer instanceof L.Circle && this._layer.options.resizeableCircle) ||
					(this._layer instanceof L.CircleMarker && this._layer.options.resizeableCircleMarker)
				) {
					const n = r([this._layer.getLatLng()]);
					...
					const n = r(this._layer.getLatLngs());
			...
			_syncLayers(t, e) {
				...
				if (!e._fromLayerSync && this._layer === e.target && this.options.syncLayersOnDrag) {
					...
					if (L.Util.isArray(this.options.syncLayersOnDrag))
						...
						for (const r in this._parentLayerGroup) {
							const n = this._parentLayerGroup[r];
							n.pm && (i = n.pm.getLayers(!0));
						}
					return (
						L.Util.isArray(i) &&
							i.length > 0 &&
							((i = i.filter((r) => !!r.pm).filter((r) => !!r.pm.options.draggable)),
							i.forEach((r) => {
	...
	var b_ = {
			_onRotateStart(t) {
				this._preventRenderingMarkers(!0),
					...
					(this._rotationOriginPoint = Gt(this._map, this._rotationOriginLatLng)),
				...
				const e = vt(this._rotationLayer, this._rotationLayer.pm._rotateOrgLatLng);
				this._fireRotationStart(this._rotationLayer, e), this._fireRotationStart(this._map, e);
			},
			_onRotate(t) {
				const e = Gt(this._map, t.target.getLatLng()),
				...
				function a(f, d = [], P = -1) {
					if ((P > -1 && d.push(P), L.Util.isArray(f[0]))) f.forEach((E, T) => a(E, d.slice(), T));
						...
						const E = d.length > 0 ? (0, Xl.default)(s._markers, d) : s._markers[0];
						f.forEach((T, G) => {
							E[G].setLatLng(T);
						});
					}
				...
				const o = vt(this._rotationLayer);
			...
			_getRotationCenter() {
				...
				const t = L.polygon(this._layer.getLatLngs(), { stroke: !1, fill: !1, pmIgnore: !0 }).addTo(
						this._layer._map
					),
					e = t.getCenter();
			...
			enableRotate() {
				...
				const t = { fill: !1, stroke: !1, pmIgnore: !1, snapIgnore: !0 };
	...
	var v_ = L.Class.extend({
			...
			_vertexValidation(t, e) {
				...
				return (
					...
					this.options[n] && typeof this.options[n] == 'function' && !this.options[n](r)
	...
	H.LayerGroup = L.Class.extend({
		initialize(t) {
			...
			const e = (r) => {
				...
				this._layers = this.getLayers();
				const n = this._layers.filter(
					(s) =>
						!s.pm._parentLayerGroup || !(this._layerGroup._leaflet_id in s.pm._parentLayerGroup)
				);
				n.forEach((s) => {
					this._initLayer(s);
				}),
			...
			e.length === 0 && (this._layers = this.getLayers()),
				...
				this._layers.forEach((i) => {
					i instanceof L.LayerGroup
						? e.indexOf(i._leaflet_id) === -1 && (e.push(i._leaflet_id), i.pm.enable(t, e))
						: i.pm.enable(t);
				});
		},
		disable(t = []) {
			t.length === 0 && (this._layers = this.getLayers()),
				this._layers.forEach((e) => {
					e instanceof L.LayerGroup
						? t.indexOf(e._leaflet_id) === -1 && (t.push(e._leaflet_id), e.pm.disable(t))
						: e.pm.disable();
				});
		},
		enabled(t = []) {
		...
		toggleEdit(t, e = []) {
			e.length === 0 && (this._layers = this.getLayers()),
				...
				this._layers.forEach((i) => {
					i instanceof L.LayerGroup
						? e.indexOf(i._leaflet_id) === -1 && (e.push(i._leaflet_id), i.pm.toggleEdit(t, e))
						: i.pm.toggleEdit(t);
				});
		},
		_initLayer(t) {
			const e = L.Util.stamp(this._layerGroup);
		...
		getLayers(t = !1, e = !0, i = !0, r = []) {
			...
			return (
					...
					? this._layerGroup.getLayers().forEach((s) => {
							n.push(s),
								s instanceof L.LayerGroup &&
									...
									(r.push(s._leaflet_id), (n = n.concat(s.pm.getLayers(!0, !0, !0, r))));
						})
				...
				e &&
					...
					(n = n.filter(
						(s) => (!L.PM.optIn && !s.options.pmIgnore) || (L.PM.optIn && s.options.pmIgnore === !1)
					))),
				n
			);
		},
		setOptions(t, e = []) {
			e.length === 0 && (this._layers = this.getLayers()),
				...
				this._layers.forEach((i) => {
					i.pm &&
						(i instanceof L.LayerGroup
							? e.indexOf(i._leaflet_id) === -1 && (e.push(i._leaflet_id), i.pm.setOptions(t, e))
							: i.pm.setOptions(t));
				});
		},
	});
	...
	var k_ = {
			...
			createCache() {
				const t = [...this._markerGroup.getLayers(), ...this.markerCache];
				this.markerCache = t.filter((e, i, r) => r.indexOf(e) === i);
			},
			_removeFromCache(t) {
				const e = this.markerCache.indexOf(t);
			...
			applyLimitFilters({ latlng: t = { lat: 0, lng: 0 } }) {
				...
				const i = [...this._filterClosestMarkers(t)];
				this.renderLimits(i);
			},
			_filterClosestMarkers(t) {
				const e = [...this.markerCache],
					i = this.options.limitMarkersToCount;
				return i === -1
					? e
					: (e.sort((n, s) => {
							const a = n._latlng.distanceTo(t),
	...
	H.Line = H.extend({
		...
		disable() {
			...
			(this._enabled = !1),
				...
				this._layer.off('remove', this.disable, this),
				this.options.allowSelfIntersection ||
					this._layer.off('pm:vertexremoved', this._handleSelfIntersectionOnVertexRemoval, this);
			const t = this._layer._path ? this._layer._path : this._layer._renderer._container;
		...
		_initMarkers() {
			...
			this._markerGroup && (this._markerGroup.removeFrom(t), this._markerGroup.clearLayers()),
				(this._markerGroup = new L.FeatureGroup()),
				(this._markerGroup._pmTempLayer = !0);
			const i = (r) => {
				if (Array.isArray(r[0])) return r.map(i, this);
				const n = r.map(this._createMarker, this);
				return (
					this.options.hideMiddleMarkers !== !0 &&
						r.map((s, a) => {
							const o = this.isPolygon() ? (a + 1) % r.length : a + 1;
		...
		_createMarker(t) {
			const e = new L.Marker(t, { draggable: !0, icon: L.divIcon({ className: 'marker-icon' }) });
			return (
				this._setPane(e, 'vertexPane'),
				(e._pmTempLayer = !0),
				this.options.rotate
		...
		_createMiddleMarker(t, e) {
			if (!t || !e) return !1;
			const i = L.PM.Utils.calcMiddleLatLng(this._map, t.getLatLng(), e.getLatLng()),
		...
		_onMiddleMarkerClick(t) {
			...
			const i = L.divIcon({ className: 'marker-icon' });
		...
		_addMarker(t, e, i) {
			...
			l.splice(a + 1, 0, r),
				...
				this._fireVertexAdded(t, L.PM.Utils.findDeepMarkerIndex(this._markers, t).indexPath, r),
			...
			if (
				...
				if (
					(this.isPolygon()
						...
						: ((d = n - 1 < 0 ? void 0 : n - 1), (f = n + 1 >= o.length ? void 0 : n + 1)),
					f !== d)
				) {
					const P = o[d],
						E = o[f];
		...
		updatePolygonCoordsFromMarkerDrag(t) {
			const e = this._layer.getLatLngs(),
				i = t.getLatLng(),
				{
					indexPath: r,
					index: n,
		...
		_checkMarkerAllowedToDrag(t) {
			...
			return (
				t.getLatLng() === this._markers[0][0].getLatLng()
					? (a += 1)
					: t.getLatLng() === this._markers[0][this._markers[0].length - 1].getLatLng() && (s += 1),
				!(s <= 2 && a <= 2)
			);
		},
		_onMarkerDragStart(t) {
			...
			if (
				...
				return;
			const { indexPath: i } = L.PM.Utils.findDeepMarkerIndex(this._markers, e);
		...
		_onMarkerDrag(t) {
			...
			const s = i.length > 1 ? (0, St.default)(this._markers, n) : this._markers,
				a = (r + 1) % s.length,
			...
			if (e._middleMarkerNext) {
				const d = L.PM.Utils.calcMiddleLatLng(this._map, l, f);
				e._middleMarkerNext.setLatLng(d);
			}
			if (e._middleMarkerPrev) {
				const d = L.PM.Utils.calcMiddleLatLng(this._map, l, u);
		...
		_onMarkerDragEnd(t) {
			...
			const n = !this.options.allowSelfIntersection && r;
	...
	H.Polygon = H.Line.extend({
		_shape: 'Polygon',
		_checkMarkerAllowedToDrag(t) {
			const { prevMarker: e, nextMarker: i } = this._getNeighborMarkers(t),
				r = L.polyline([e.getLatLng(), t.getLatLng()]),
				n = L.polyline([t.getLatLng(), i.getLatLng()]),
				s = pt(this._layer.toGeoJSON(15), r.toGeoJSON(15)).features.length,
				a = pt(this._layer.toGeoJSON(15), n.toGeoJSON(15)).features.length;
	...
	H.Rectangle = H.Polygon.extend({
		...
		_initMarkers() {
			...
			this._markerGroup && this._markerGroup.clearLayers(),
				...
				this._layer.getLatLngs()[0].forEach((i, r) => {
					const n = this._cornerMarkers.find((s) => s._index === r);
					n && n.setLatLng(i);
				});
		},
		applyOptions() {
		...
		_createMarker(t, e) {
			const i = new L.Marker(t, { draggable: !0, icon: L.divIcon({ className: 'marker-icon' }) });
			return (
				this._setPane(i, 'vertexPane'),
				(i._origLatLng = t),
				(i._index = e),
		...
		_addMarkerEvents() {
			this._markers[0].forEach((t) => {
				t.on('dragstart', this._onMarkerDragStart, this),
					...
					this.options.preventMarkerRemoval || t.on('contextmenu', this._removeMarker, this);
			});
		},
		_removeMarker() {
			return null;
		...
		_onMarkerDragStart(t) {
			...
			(e._oppositeCornerLatLng = i.find((n) => n._index === (e._index + 2) % 4).getLatLng()),
				(e._snapped = !1);
			const { indexPath: r } = L.PM.Utils.findDeepMarkerIndex(this._markers, e);
		...
		_adjustRectangleForMarkerMove(t) {
			...
			const e = L.PM.Utils._getRotatedRectangle(
				t.getLatLng(),
		...
		_adjustAllMarkers(t) {
			const e = this._layer.getLatLngs()[0];
			if (e && e.length !== 4 && e.length > 0)
				...
				const i = e.findIndex((r) => t.getLatLng().equals(r));
				i > -1
		...
		_findCorners() {
			this._angle === void 0 &&
				this.setInitAngle(
					ke(this._map, this._layer.getLatLngs()[0][0], this._layer.getLatLngs()[0][1]) || 0
				);
			const t = this._layer.getLatLngs()[0];
	...
	H.CircleMarker = H.extend({
		...
		disable() {
			this.dragging() ||
				...
				this._map &&
					...
					this._helperLayers &&
						(this._helperLayers.clearLayers(), this._helperLayers.removeFrom(this._map)),
					this.options[this._editableOption]
		...
		applyOptions() {
			this.options[this._editableOption]
				...
				: (this.options.draggable && this.enableLayerDrag(),
					...
					this.options.snappable ? this._initSnappableMarkersDrag() : this._disableSnappingDrag()),
		...
		_initMarkers() {
			const t = this._map;
			this._helperLayers && (this._helperLayers.removeFrom(t), this._helperLayers.clearLayers()),
				(this._helperLayers = new L.FeatureGroup()),
				(this._helperLayers._pmTempLayer = !0),
				this._helperLayers.addTo(t);
			const e = this._layer.getLatLng(),
		...
		_moveCircle(t) {
			...
			const i = this._centerMarker.getLatLng();
			this._layer.setLatLng(i);
			const r = this._layer._radius,
		...
		_onMarkerDragEnd(t) {
			...
			const e = t.target;
			this._vertexValidationDragEnd(e) &&
				(this.options[this._editableOption] && (this._fireEdit(), (this._layerEdited = !0)),
		...
		_updateHiddenPolyCircle() {
			const t = this._layer._map || this._map;
			if (t) {
				const e = L.PM.Utils.pxRadiusToMeterRadius(
				...
				i.setRadius(e);
				const r = t && t.pm._isCRSSimple();
				this._hiddenPolyCircle
					? this._hiddenPolyCircle.setLatLngs(L.PM.Utils.circleToPolygon(i, 200, !r).getLatLngs())
	...
	H.Circle = H.CircleMarker.extend({
		...
		_extedingMarkerDragEnd() {},
		_updateHiddenPolyCircle() {
			const t = this._map && this._map.pm._isCRSSimple();
			this._hiddenPolyCircle
	...
	H.ImageOverlay = H.extend({
		...
		disable() {
			this._dragging ||
				...
				this._layer.off('remove', this.disable, this),
				this.enabled() ||
					(this._layerEdited && this._fireUpdate(), (this._layerEdited = !1), this._fireDisable()),
				(this._enabled = !1));
		},
		_findCorners() {
			const t = this._layer.getBounds(),
				e = t.getNorthWest(),
				i = t.getNorthEast(),
				r = t.getSouthEast(),
				n = t.getSouthWest();
	...
	H.Text = H.extend({
		...
		_autoResize() {
			...
			const t = this.textArea.scrollHeight > 21 ? this.textArea.scrollHeight : 21,
		...
		_focusChange(t = {}) {
			...
			(this._hasFocus = t.type === 'focus'),
				!e != !this._hasFocus &&
					(this._hasFocus
						? (this._applyFocus(), (this._focusText = this.getText()), this._fireTextFocus())
						: (this._removeFocus(),
							this._fireTextBlur(),
							this._focusText !== this.getText() && (this._fireEdit(), (this._layerEdited = !0))));
		},
		_applyFocus() {
		...
		_initTextMarker() {
			if (
				...
				const e = this.options.className.split(' ');
				this.textArea.classList.add(...e);
			}
			const t = L.PM.Draw.Text.prototype._createTextIcon.call(this, this.textArea);
	...
	lr.prototype = {
		...
		rotate(t, e) {
			const i = Math.cos(t),
				r = Math.sin(t);
			return (
				(e = e || new L.Point(0, 0)), this._add(i, r, -r, i, e.x, e.y)._add(1, 0, 0, 1, -e.x, -e.y)
			);
		},
		flip() {
	...
	var M_ = {
			...
			findLayers(t) {
				...
				return (
					...
					(e = e.filter(
						(i) => (!L.PM.optIn && !i.options.pmIgnore) || (L.PM.optIn && i.options.pmIgnore === !1)
					)),
					e
				);
			},
			...
			_fireEvent(t, e, i, r = !1) {
				t.fire(e, i, r);
				const { groups: n } = this.getAllParentGroups(t);
				n.forEach((s) => {
					s.fire(e, i, r);
				});
			},
			getAllParentGroups(t) {
				const e = [],
					i = [],
					r = (n) => {
						for (const s in n._eventParents)
							if (e.indexOf(s) === -1) {
								e.push(s);
								const a = n._eventParents[s];
								i.push(a), r(a);
							}
					};
			...
			findDeepCoordIndex(t, e, i = !0) {
				...
				let s = {};
				return (
					r && (s = { indexPath: r, index: r[r.length - 1], parentPath: r.slice(0, r.length - 1) }),
					s
				);
			},
			findDeepMarkerIndex(t, e) {
				...
				let n = {};
				return (
					i && (n = { indexPath: i, index: i[i.length - 1], parentPath: i.slice(0, i.length - 1) }),
					n
				);
			},
			_getIndexFromSegment(t, e) {
				if (e && e.length === 2) {
					...
					return (
						...
						{ indexA: i, indexB: r, newIndex: n, indexPath: i.indexPath, parentPath: i.parentPath }
					);
				}
				return null;
			},
	...
	L.PM = L.PM || {
		...
		addInitHooks() {
			...
			function e() {
				(this.pm = void 0),
					L.PM.optIn
						? this.options.pmIgnore === !1 && (this.pm = new L.PM.Edit.LayerGroup(this))
			...
			function r() {
				(this.pm = void 0),
					L.PM.optIn
						? this.options.pmIgnore === !1 && (this.pm = new L.PM.Edit.CircleMarker(this))
			...
			function n() {
				(this.pm = void 0),
					L.PM.optIn
						? this.options.pmIgnore === !1 && (this.pm = new L.PM.Edit.Line(this))
			...
			function s() {
				(this.pm = void 0),
					L.PM.optIn
						? this.options.pmIgnore === !1 && (this.pm = new L.PM.Edit.Polygon(this))
			...
			function a() {
				(this.pm = void 0),
					L.PM.optIn
						? this.options.pmIgnore === !1 && (this.pm = new L.PM.Edit.Rectangle(this))
			...
			function o() {
				(this.pm = void 0),
					L.PM.optIn
						? this.options.pmIgnore === !1 && (this.pm = new L.PM.Edit.Circle(this))
			...
			function l() {
				(this.pm = void 0),
					L.PM.optIn
						? this.options.pmIgnore === !1 && (this.pm = new L.PM.Edit.ImageOverlay(this))
