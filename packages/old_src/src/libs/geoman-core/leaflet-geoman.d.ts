...
declare module 'leaflet' {
	...
	interface Evented {
		...
		on(type: 'pm:globalunionmodetoggled', fn: PM.GlobalUnionModeToggledEventHandler): this;
		once(type: 'pm:globalunionmodetoggled', fn: PM.GlobalUnionModeToggledEventHandler): this;
		off(type: 'pm:globalunionmodetoggled', fn?: PM.GlobalUnionModeToggledEventHandler): this;
	...
	namespace PM {
		 ...
		 */
		export type GlobalUnionModeToggledEventHandler = (e: { enabled: boolean; map: L.Map }) => void;

		/**
		 * UNION EVENT HANDLERS
		 */
		export type UnionEventHandler = (e: { resultLayer: L.Layer; mergedLayers: L.Layer[] }) => void;
