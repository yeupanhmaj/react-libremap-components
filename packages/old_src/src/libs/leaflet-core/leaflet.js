...
!((t, e) => {
	...
	function c(t, e) {
		for (var i in (Object.hasOwn(t, 'options') || (t.options = t.options ? R(t.options) : {}), e))
			t.options[i] = e[i];
		return t.options;
	}
	function U(t, e, i) {
	...
	var d = Array.isArray || ((t) => '[object Array]' === Object.prototype.toString.call(t));
	function G(t, e) {
	...
	(et.extend = function (t) {
		...
		for (i in (((o.constructor = e).prototype = o), this))
			Object.hasOwn(this, i) && 'prototype' !== i && '__super__' !== i && (e[i] = this[i]);
		...
		function e(t) {
			...
			1 !== t.detail
				...
				: 'mouse' === t.pointerType ||
					...
					((e = Ne(t)).some((t) => t instanceof HTMLLabelElement && t.attributes.for) &&
						!e.some((t) => t instanceof HTMLInputElement || t instanceof HTMLSelectElement)) ||
					((e = Date.now()) - o <= ie
						? 2 === ++n &&
							i(
								((t) => {
	...
	var mt = {
		...
		A = it.extend({
			...
			_rebound: (t, e) =>
				0 < t + e ? Math.round(t - e) / 2 : Math.max(0, Math.ceil(t)) - Math.max(0, Math.floor(e)),
	...
	var vt = {
		...
		di = et.extend({
			...
			_createImg: (t, e) => (((e = e || document.createElement('img')).src = t), e),
			...
			setStyle: function (t) {
				return (
					...
					this._renderer &&
						...
						this.options.stroke && t && Object.hasOwn(t, 'weight') && this._updateBounds()),
					this
				);
			},
			bringToFront: function () {
			...
			if (e) {
				...
				if ((void 0 === t && (t = e.getCenter()), void 0 !== this._tileZoom)) {
					...
					if (1 < Math.abs(i - this._tileZoom)) this._setView(t, i);
						...
						if ((r.sort((t, e) => t.distanceTo(s) - e.distanceTo(s)), 0 !== r.length)) {
	...
	var Vi = (() => {
			...
			return (t) =>
				document.createElement('<' + t + ' xmlns="urn:schemas-microsoft.com:vml" class="lvml">');
		})(),
		zt = {
			_initContainer: function () {
